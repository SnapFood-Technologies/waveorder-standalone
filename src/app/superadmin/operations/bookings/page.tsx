    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center gap-4">
        ...
        <div>
          ...
          <p className="text-gray-600 mt-1">Service appointment and booking analytics across businesses</p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-gray-200 p-12">
        <div className="text-center max-w-md mx-auto">
          ...
          <p className="text-gray-600 mb-6">
            Bookings analytics will provide insights into service appointments across your salon, spa, and service-based businesses, including booking trends, popular services, and utilization rates.
          </p>
