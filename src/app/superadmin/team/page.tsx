...
import { 
  ...
  MoreVertical, ChevronDown, ExternalLink, AlertCircle
} from 'lucide-react'
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 z-[60] flex items-center justify-center p-4">
          <div className="bg-white rounded-lg max-w-md w-full p-6">
            ...
            <p className="text-gray-700 mb-6">
              Are you sure you want to delete <strong>"{member.name}"</strong>? This will remove them from the team permanently.
            </p>
