// components/superadmin/StorefrontViewsChart.tsx
'use client'
...
interface StorefrontViewsChartProps {
  className?: string
}
...
export function StorefrontViewsChart({ className = '' }: StorefrontViewsChartProps) {
  ...
  const fetchData = async () => {
    try {
      ...
      const response = await fetch(`/api/superadmin/analytics?${params}`)
      ...
      <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 mb-6">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-600">Views across all business storefronts</p>
          </div>
        </div>
