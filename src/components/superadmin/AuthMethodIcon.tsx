import { Key, Link, UserCheck } from 'lucide-react';

interface AuthMethodIconProps {
  authMethod: 'google' | 'email' | 'magic-link' | 'oauth';
}

export function AuthMethodIcon({ authMethod }: AuthMethodIconProps) {
  switch (authMethod) {
    case 'google':
      return (
        <div className="w-4 h-4 bg-white rounded-full flex items-center justify-center border border-gray-200" title="Google Sign-in">
