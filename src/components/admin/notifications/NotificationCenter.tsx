...
export function NotificationCenter({ businessId }: NotificationCenterProps) {
  ...
  const handleMarkAsRead = async (notificationId: string) => {
    try {
      const response = await fetch(`/api/admin/stores/${businessId}/notifications/${notificationId}/read`, {
        method: 'PUT'
      })
      if (response.ok) {
  ...
  const handleMarkAllAsRead = async () => {
    try {
      const response = await fetch(`/api/admin/stores/${businessId}/notifications/mark-all-read`, {
        method: 'PUT'
      })
      if (response.ok) {
        setNotifications(prev => 
