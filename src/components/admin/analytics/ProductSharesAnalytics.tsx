    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900">Product Shares</h1>
            <p className="text-sm text-gray-600">Track how your products are being shared</p>
          </div>
        </div>
        ...
        <>
          ...
          <div className="bg-white rounded-lg border border-gray-200 p-6">
            ...
            <p className="text-xs text-gray-500">
              Visits from product share links in the selected period
            </p>
          </div>
          ...
          <div className="bg-white rounded-lg border border-gray-200">
            <div className="p-6 border-b border-gray-200">
              <div className="flex items-center gap-2">
                ...
                <h2 className="text-lg font-semibold text-gray-900">Top Shared Products</h2>
              </div>
              <p className="text-sm text-gray-600 mt-1">
                Products that drive the most traffic from share links
              </p>
            </div>
            ...
            {data?.topSharedProducts && data.topSharedProducts.length > 0 ? (
              ...
              <div className="p-12 text-center">
                ...
                <p className="text-gray-600 max-w-sm mx-auto">
                  When customers share your products and others visit those links, the data will appear here.
                </p>
              </div>
            )}
          </div>
          ...
          <div className="bg-purple-50 border border-purple-200 rounded-lg p-4">
            <h3 className="font-medium text-purple-900 mb-2">How Product Sharing Works</h3>
            <ul className="text-sm text-purple-700 space-y-1">
              <li>• Customers can share products using the share button on product details</li>
